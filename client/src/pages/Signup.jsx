...
import { Eye, EyeOff, Sparkles, ArrowRight, Loader2, UserPlus } from "lucide-react";
      ...
      <div className="brand-panel hidden lg:flex lg:w-1/2 bg-[#020617] relative overflow-hidden flex-col justify-between p-16 xl:p-24">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-6xl xl:text-8xl font-black text-white tracking-tighter leading-[0.85] mb-8">
            Design <br /> your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-cyan-400 to-emerald-400">identity.</span>
          </h2>
        </div>
      </div>
